/*
  PK_Foundation.js
  ZURB Foundation js remixed by PK
  pawelkolman.github.io
  
  INCLUDED: jquery.js, foundation.js
*/
...
// makes switches from inputs
$("input[type='switch']").each(function() {
  var name = $(this).attr('name');
  $(this).replaceWith("<div class=\"switch tiny\"><input class=\"switch-input\" id=\"switch-id-"+name+"\" type=\"checkbox\" name=\""+name+"\""+($(this).attr('checked') ? ' checked' : '')+"><label class=\"switch-paddle\" for=\"switch-id-"+name+"\"></label></div>");
});
